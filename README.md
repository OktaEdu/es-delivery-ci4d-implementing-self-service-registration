...
- Configure a user profile policy and enable self-service registration.
- Create a Registration Inline Hook linked to your external service and associate the hook with the user profile policy.
- Test out the end-user experience.
